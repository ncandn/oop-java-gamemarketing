...
public class RegisterUI {
	...
	private PersonFactory perosnFactory = new PersonFactory();
			...
			public void actionPerformed(ActionEvent e) {
		            ...
		            if(mng.getSocial().getUserMap().get(j_Username.getText()) == null)
		            {
			            ...
			            if (j_ConfirmPassword.getText().equals(j_Password.getText()) ) {
							Person person_factory = perosnFactory.getPerson("USER",username,name,lastName,textFieldNickname.getText(),
									j_Password.getText(),email,address, phoneNumber, birthdate);
			            	User user = (User)person_factory;
							try {
